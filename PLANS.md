...
- [x] Search saved loadouts by loadout or assigned character name while preserving alphabetical ordering, style snapshot category badges consistently in rows/previews/exports, and format category-prefixed snapshot names without rewriting existing names until a tag changes.
