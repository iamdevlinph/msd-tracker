...
export const EQUIPMENT_SET_EFFECTS_DATA = {
	...
	"Gourmand's Grand Banquet": [
		{ pieces: 2, effect: "Effect details pending." },
	],
	"Devourer of the Abyss": [{ pieces: 2, effect: "Effect details pending." }],
	"Forest Tyrant": [
		{ pieces: 2, effect: "Effect details pending." },
		{ pieces: 4, effect: "Effect details pending." },
	],
	Sirius: [
		{ pieces: 2, effect: "Effect details pending." },
		{ pieces: 4, effect: "Effect details pending." },
	],
	"Ancient Stone": [{ pieces: 2, effect: "Effect details pending." }],
	"Mount Tai's Towering Might": [
		{ pieces: 2, effect: "Effect details pending." },
		{ pieces: 4, effect: "Effect details pending." },
	],
	"Heart of Eternal Frost": [{ pieces: 2, effect: "Effect details pending." }],
	"Vanguard of Victory": [{ pieces: 2, effect: "Effect details pending." }],
	"Gourmand Level": [
		{ pieces: 2, effect: "Effect details pending." },
		{ pieces: 4, effect: "Effect details pending." },
	],
	...
	"Thousand-Year-Old Tree": [{ pieces: 2, effect: "Effect details pending." }],
	...
	"Blossoms in Full Bloom": [{ pieces: 2, effect: "Effect details pending." }],
